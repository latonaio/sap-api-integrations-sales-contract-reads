...
import (
	...
	sap_api_input_reader "sap-api-integrations-sales-contract-reads/SAP_API_Input_Reader"
	"sap-api-integrations-sales-contract-reads/config"
...
func main() {
	...
	inputSDC := fr.ReadSDC("./Inputs//SDC_Sales_Contract_Header_sample.json")
	...
	caller.AsyncGetSalesContract(
		inputSDC.SalesContract.SalesContract,
		inputSDC.SalesContract.SalesContractItem.SalesContractItem,
		accepter,
	)
}
